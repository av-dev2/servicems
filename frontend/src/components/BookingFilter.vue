<template>
    <div class="flex justify-around w-full  mt-4 h-15 border-2 rounded-2xl">
        <div class="flex items-center mx-20 gap-20">
            <div class="flex-initial w-48 border-2 border-cyan-500/50 shadow-cyan-900/50 rounded-2xl">
                <DatePicker
